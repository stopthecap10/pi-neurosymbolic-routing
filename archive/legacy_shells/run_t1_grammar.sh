...
# Tier-1 Phi-2 Q8 baseline with grammar constraints + energy logging
...
OUT_CSV="outputs/T1_phi2_q8_grammar_r${REPEATS}_${RUN_ID}.csv"
TRIALS_CSV="outputs/T1_phi2_q8_grammar_r${REPEATS}_${RUN_ID}_trials.csv"
