...
# Tier-1 Phi-4-Mini Q6_K with grammar constraints + energy logging
...
OUT_CSV="outputs/T1_phi4_mini_q6k_grammar_r${REPEATS}_${RUN_ID}.csv"
TRIALS_CSV="outputs/T1_phi4_mini_q6k_grammar_r${REPEATS}_${RUN_ID}_trials.csv"

python3 src/log_run_energy.py \
  --system phi4_mini_q6k_grammar \
  --tier T1 \
  --csv_used "$CSV_PATH" \
